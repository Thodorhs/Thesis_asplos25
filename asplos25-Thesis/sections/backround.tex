...
\subsection{Network Block Device (NBD)}
 ...
 \begin{figure}[h]
    \includegraphics[scale=0.22]{asplos25-Thesis/figures/nbd-path.png}\\
...
\begin{figure}[h]
    \includegraphics[scale=0.18]{asplos25-Thesis/figures/nbd-path2.png}\\
...
\begin{figure}[H]
\includegraphics[scale=0.18]{asplos25-Thesis/figures/spdk-target.png}\\
